...
def admit_patient(request, id):
    ...
    if request.method == "POST":
        ...
        if not doctor_id or not ward_id:
            return render(
                request,
                "hospital/reception.html",
                {
                    ...
                    "error": "Doctor and ward are required",
                },
            )
...
def create_prescription(request):
    ...
    return render(
        request,
        "hospital/create_prescription.html",
        {
            "patients": patients,
            "doctors": doctors,
        },
...
def prescription_list(request):
    ...
    return render(
        request,
        "hospital/prescriptions_list.html",
        {
...
def edit_prescription(request, id):
    ...
    return render(
        request,
        "hospital/edit_prescription.html",
        {
...
def create_emergency(request):
    ...
    if request.method == "POST":
        ...
        if not patient_name:
            return render(
                request,
                "hospital/create_emergency.html",
                {
                    "doctors": doctors,
